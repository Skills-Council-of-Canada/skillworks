          ...
          <div className="relative bg-white rounded-lg shadow-sm p-3 sm:p-6">
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-6">
              ...
              <div className="flex-1 min-w-0 w-full">
                <div className="flex flex-col sm:flex-row justify-between items-center sm:items-start gap-3 sm:gap-4">
        ...
        <div className="w-full overflow-hidden">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="overflow-x-auto scrollbar-none -mx-3 px-3">
              <TabsList className="mb-6 sm:mb-8 w-full inline-flex sm:flex justify-start bg-transparent p-0 h-auto">
                <TabsTrigger 
                  value="profile" 
                  className="flex-1 sm:flex-none text-sm py-2.5 px-2 sm:px-6"
                >
                  Profile
                </TabsTrigger>
                <TabsTrigger 
